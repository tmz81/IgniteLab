...
import reactIcon from "../assets/react-icon-background.svg"
...
export function Subscribe() {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[940px] flex items-center justify-between mt-20 mx-auto">
        <div className="max-w-[640px]">
          <Logo />
          <h1 className="mt-8 text-[2.5rem] leading-tight">
            Comece a usar <strong className="text-blue-500">ReactJS</strong><br/>do jeito certo
          </h1>
          <p className="mt-4 text-gray-200 leading-relaxed">
          Construa uma aplicação completa usando as tecnologias mais modernas e <br/>acelere sua evolução na programação.
          </p>
          ...
          <div className="w-full max-w-[1280px] mt-2 block" >
            <p className="mb-4 mt-8 text-[16px]">
              Evento ministrado por:
            </p>
            <div className="flex gap-2 mt-6">
              <div>
                <a href="https://github.com/tmz81" target="_blank">
                  <img
                    className="h-14 w-14 rounded-full border-2 border-blue-500 leading-relaxed"
                    src="https://www.github.com/tmz81.png"
                    alt="Foto perfil professor"
                  />
                </a>
              </div>
              <div>
                <h5
                  className="font-sans text-[15px] block">
                  <strong>Thomaz Victor</strong>
                </h5>
                <span
                  className="text-gray-200 text-[14px] block ">
                  @tmz81 - Developer Web
                </span>
              </div>
            </div>
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          <strong className="text-2xl mb-6 block">Participe gratuitamente</strong>
      ...
      <img src={reactIcon} className="absolute mt-1 max-h-[940px]" alt="image-background-react" />
      <img src={CodeMockupImg} className="max-w-[940px]" alt="image-background" />
    </div>
  )
}